...
Source: research/strategy.md Section 5 (founder decision D1, no live count), research/docs/benchmark.md (minimum-N, indirect identification), research/docs/cjm-to-be.md (privacy bundle), CLAUDE.md privacy mechanism.
