...
*This is the raw inventory drawn from research/docs/research.md, strategy.md, competitive-analysis.md, ux-patterns.md, and benchmark.md. Personas below grow directly from these observations.*
...
Source: research/docs/competitors.md, "3 Common Patterns" - Pattern 2.
...
Source: research/docs/competitors.md, "3 Key Differences" - Sales motion.
...
Source: research/docs/ux-patterns.md, Patterns B1 and B4.
...
Source: research/docs/ux-patterns.md, Pattern B1.
...
Source: research/strategy.md, Riskiest Assumption; research/docs/aarrr.md, Activation section.
...
Source: research/docs/competitors.md, Officevibe key mechanism; research/docs/ux-patterns.md, Pattern B4.
...
Source: research/strategy.md, Business Model; research/docs/aarrr.md, Revenue section.
...
Source: research/docs/ux-patterns.md, Pattern B2.
...
Source: research/strategy.md, Segment B; research/docs/research.md, Segments.
...
Source: research/docs/research.md, "Problem" section; research/docs/benchmark.md, Mechanism 2.
...
Source: research/docs/aarrr.md, Referral section.
...
Source: research/docs/research.md, Key Conclusion 3; research/strategy.md, Segment C.
...
Source: research/docs/benchmark.md, "Mechanism That Will Not Work"; research/docs/ux-patterns.md, Pattern B3.
...
Source: research/docs/ux-patterns.md, Pattern B5 [MOST CRITICAL]; research/docs/benchmark.md, Mechanism 2.
...
Source: research/docs/ux-patterns.md, Pattern B3.
...
Source: research/docs/benchmark.md, Mechanism 2; research/docs/ux-patterns.md, Pattern B5.
...
Source: research/docs/benchmark.md, Benchmark Scores and "Mechanism That Will Not Work."
...
Source: research/docs/benchmark.md, "Mechanism That Will Not Work."
...
Source: research/strategy.md Section 5 (D1/D4/D5); research/live-research.md K1 (resolution). Legal deferral: research/docs/research.md Open Question Q1.
...
- No self-serve path: every tool she found either requires a demo call or assumes an HR team she does not have. Source: research/docs/competitors.md, Woliba/Nivati/Wellable demo requirements.
...
Source: research/strategy.md Segment A (CONFIRMED role profile), research/docs/competitors.md (CONFIRMED no-HR gap), research/docs/ux-patterns.md B1/B4 (CONFIRMED operator behavioral patterns).
...
[?] Whether the owner or operator discovers Brio first is an open question (Open Question Q2 from research/docs/research.md). This persona assumes operator-led discovery, which is the primary hypothesis. If research shows owners discover first, the landing page messaging must shift substantially.
...
- Woliba's burnout signals by manager feel invasive and legally uncomfortable. Source: research/docs/competitors.md, Woliba privacy note.
- Officevibe was the closest analog but is now $4,999/year flat, pricing him out. Source: research/docs/competitors.md, Key Differences.
...
**Mood quote:**
"I don't need to know who's unhappy. I need to know if the team is doing OK as a whole before I lose another good person." [?] Synthesis from research/docs/research.md, Segments section and ux-patterns.md B2. Mark as hypothesis, not a real quote.

Source: research/strategy.md Segment B (CONFIRMED role profile), research/docs/ux-patterns.md B2 (CONFIRMED behavioral pattern), research/docs/competitors.md Officevibe/Woliba notes.
...
**Mood quote:**
"I'll participate if I actually believe no one can see my answer. But I've been told that before. Show me exactly how it works, not just a promise." [?] Synthesis from research/docs/benchmark.md (Limeade/Typeform anti-pattern analysis) and research/docs/ux-patterns.md B3/B5. Mark as hypothesis, not a real quote.

Source: research/docs/benchmark.md B3/B5 (CONFIRMED behavioral pattern), research/docs/benchmark.md Mechanism 1 and Mechanism 2 (CONFIRMED trust mechanisms), research/docs/benchmark.md "Mechanism That Will Not Work" (CONFIRMED anti-pattern).

---

### Why Three Personas, Not Four

A fourth persona (HR professional or "wellbeing coordinator" at a slightly larger SMB) was considered. Discarded because: the research confirms that designing for an HR professional shifts the product into the territory of all current competitors, each of whom has assumed an HR sponsor. Brio's differentiation is precisely that it does not assume an HR layer. Adding an HR-professional persona would pull design decisions toward features and language that undermine the primary persona's experience. Source: research/docs/competitors.md, "What Is Missing Across All" - gap 1.
